...
# PATHS REQUIRED
base_path = "/home/ubuntu/last/Sendingmails/"
without_mask_path = "/home/ubuntu/last/without_mask/"
faces_db_path = "/home/ubuntu/last/Faces.db"


# I HAVE REMOVED THE PASSWORDS
...
# send_mail function
# sends mail to the recognized person
...
#deleting the files present in the email process ics
files = os.listdir("/home/ubuntu/last/Sendingmails/emailprocesspics/")
for each_file in files:
	os.remove("/home/ubuntu/last/Sendingmails/emailprocesspics/{}".format(each_file))
print("Deleted the files present in emailprocesspics")

#deleting the files present in without_mask_folder
os.system("rm -rf /home/ubuntu/last/without_mask")
os.system("mkdir /home/ubuntu/last/without_mask")

#os.system("rm -rf /home/last/Sendingmail/emailprocesspics/")
#os.system("mkdir /home/last/Sendingmail/emailprocesspics/")
# sending the unknown
